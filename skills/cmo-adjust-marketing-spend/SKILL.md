---
name: cmo-adjust-marketing-spend
description: >
...
requires deeper investigation, route to `/cmo-get-diagnosis`.
...
Route to `/cmo-get-diagnosis` on CONTRIBUTION-MARGIN immediately after the
...
- To diagnose a specific underperforming metric in depth → `/cmo-get-diagnosis`
